...
import { Walt, WaltMark, Icon, PersonaSwitch } from '../lib/components.jsx';
import { StepDot } from './shared.jsx';

// ─────────────────────────────────────────────────────────────
//  FOUNDATIONS — design system at-a-glance
// ─────────────────────────────────────────────────────────────
export function FoundationsScreen({ theme = 'dark' }) {
  return (
...
//  LANDING PAGE
// ─────────────────────────────────────────────────────────────
export function LandingPage({ theme = 'dark' }) {
  return (
    <div data-theme={theme} className="walt-root" style={{
      width: '100%', minHeight: '100%',
      background: 'var(--bg-app)',
    ...
    <div style={{ padding: '90px 56px', borderBottom: '1px solid var(--border-subtle)' }}>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 28 }}>
        ...
        <PersonaCard
          ...
          body="Walt queries the same gold tables your engineers maintain. Every answer comes with the SQL, the source rows, and a notebook you can fork. No more 'is this number right?'."
