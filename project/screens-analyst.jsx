// Analyst experience + supporting engineer surfaces.
// Renders inside the same WaltWindow chrome.

// ─────────────────────────────────────────────────────────────
//  Analyst app — question-first, dashboard artifact on the right
// ─────────────────────────────────────────────────────────────
function AnalystApp() {
  return (
...
function hilite(t) {
  // very small SQL highlighter for the artifact view
  return t
...
Object.assign(window, { AnalystApp, hilite });
