// Engineer experience — the core Walt DE surface.
// Layout: nav-rail | session sidebar | conversation | artifact panel (tabs: Plan / Workspace / Context)
...
// ─────────────────────────────────────────────────────────────
//  Nav rail — icon-only column, left edge
// ─────────────────────────────────────────────────────────────
function NavRail({ active = 'sessions' }) {
  const items = [
...
// ─────────────────────────────────────────────────────────────
//  Conversation pane — header, messages w/ tool calls, composer
// ─────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────
//  Artifact panel — tabs: Plan, Workspace, Context. Tab content
//  is the live artifact that walt produces / mutates.
// ─────────────────────────────────────────────────────────────
...
// PLAN tab — overall plan w/ medallion link, lineage, semantic model
function PlanTab() {
  return (
...
// WORKSPACE tab — local / github folder tree
...
// CONTEXT tab — files, MCP tools, sources Walt has access to
function ContextTab() {
  return (
...
Object.assign(window, { EngineerApp, NavRail, SessionsSidebar, ConversationPane, ArtifactPanel });
